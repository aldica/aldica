...
public class JakartaSession extends BaseSession implements HttpSession
{
    ...
    JakartaSession(final String id, final HttpSession session, final boolean isNew, final ServletContext ctx, final WebSessionEntity entity,
