...
docker-compose -f target\docker\start-stop-test-compose.yml logs --tail 6 keepAlive01 | grep -o "Ignite instance repositoryGrid currently has 1 active nodes"
