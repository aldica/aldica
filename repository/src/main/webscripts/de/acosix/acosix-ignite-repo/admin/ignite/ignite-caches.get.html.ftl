...
<@page title=msg("ignite.caches.title") readonly=true customCSSFiles=["ootbee-support-tools/css/jquery.dataTables.css", "acosix/ignite-admin-console.css"]
    customJSFiles=["ootbee-support-tools/js/jquery-2.2.3.js", "ootbee-support-tools/js/jquery.dataTables.js", "acosix/ignite-admin-caches.js"]>
