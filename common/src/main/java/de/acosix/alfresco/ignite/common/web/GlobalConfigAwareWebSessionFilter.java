...
package de.acosix.alfresco.ignite.common.web;
...
public class GlobalConfigAwareWebSessionFilter extends WebSessionFilter
{
    ...
    private static final String PROP_WEB_SESSION_CACHE_ENABLED = "acosix-ignite.webSessionCache.enabled";

    private static final String PROP_WEB_SESSION_CACHE_INSTANCE_NAME = "acosix-ignite.webSessionCache.instanceName";

    private static final String PROP_WEB_SESSION_CACHE_CACHE_NAME = "acosix-ignite.webSessionCache.cacheName";

    private static final String PROP_WEB_SESSION_CACHE_RETRIES_ON_FAIL = "acosix-ignite.webSessionCache.retriesOnFailure";

    private static final String PROP_WEB_SESSION_CACHE_RETRIES_TIMEOUT = "acosix-ignite.webSessionCache.retriesTimeout";

    private static final String PROP_WEB_SESSION_CACHE_KEEP_BINARY = "acosix-ignite.webSessionCache.keepBinary";
