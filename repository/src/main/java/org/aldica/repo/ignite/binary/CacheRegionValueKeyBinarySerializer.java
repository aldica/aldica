...
/**
 * Instances of this class handle (de-)serialisations of {@link CacheRegionValueKey} instances into more efficient binary representations as
 ...
 * of handling the (typically pre-defined / well-known) region names. Since cache region value key instances are immutable and we currently
 * do not use any in-memory queries on cached data using the serial form, this serializer may use {@link BinaryRawWriter} and
 * {@link BinaryRawReader} to achieve an even more compact serial form.
 *
 * @author Axel Faust
 */
